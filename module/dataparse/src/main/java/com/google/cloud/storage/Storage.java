...
public interface Storage extends Service<StorageOptions> {
   ...
   * a service account signer. If an instance of {@link ServiceAccountSigner} was
   ...
   */
  URL signUrl(BlobInfo blobInfo, long duration, TimeUnit unit, Map<String, String> headers, SignUrlOption... options);
